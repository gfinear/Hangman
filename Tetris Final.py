        ...
        for rows in range(self.row):
            ...
            if len(empty_row) == self.col:
                ...
                for items in dropped_shapes:
                    if items.z.y < rows:
##                    if items.can_move(0, 1, self.col, self.row) == True:
                        items.move_1(0,1)
...
##            global full_row
##            x=0
##            for values in dropped_shapes:
##                    if rows == values.z.y:
##                        x+=1
##                        full_row.append(values)
##                        a = values
##            if x == self.col:
##                x=0
##                dropped_shapes.remove(a)
##                while True:
##                    for items in full_row:
##                        items.undraw()
...
##win = GraphWin("Tetronimoes", 900, 600)
game = Game(10,18)
